...
namespace Mario.Characters
{
    ...
    {
        Sound stompSound = new Sound(new ResourceProxy().GetSound("stomp"));
        ...
        {
            this.Name = "mario";
            this.EntitySpriteSheet = new ResourceProxy().GetSpriteSheet("sm-mario-sprites");
        ...
        {
            this.IsMoving = false;
            new ResourceProxy().GetSound("mariodie").Play();

            new ResourceProxy().StopSound("music-1");

            while (new ResourceProxy().GetSound("mariodie").Status == SFML.Audio.SoundStatus.Playing)
            { }
